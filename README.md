...
## Automatyczny odczyt
Netlify zleca odczyt rodziców o 06:30 i 18:00, a ucznia dwie minuty później (Europe/Warsaw). GitHub Actions odczytuje dane, szyfruje raport i publikuje go w Pages. Kontrola po 10 i 20 minutach ponawia zlecenie tylko przy braku zweryfikowanej publikacji; zdrowy raport z bieżącego okna nie wymaga kolejnego logowania do Librusa. Komputer domowy może być wyłączony. Kolejki i awarie usług nadal mogą opóźnić raport. Przycisk „Sprawdź raport” pobiera ostatni plik; w aplikacji iOS przycisk „Odśwież z Librusa” uruchamia nowy odczyt przez zabezpieczoną funkcję Netlify i czeka na publikację. Build 3 automatycznie sprawdza gotowy raport po powrocie do aplikacji. Oznaczenia pozostają lokalne na urządzeniu, zgodnie z decyzją rodziny. Szczegóły: server/README.md i ios/README.md.
